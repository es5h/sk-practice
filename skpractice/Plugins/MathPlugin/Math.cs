...
public class Math
{
    ...
    public string Sqrt(SKContext context) =>
        System.Math.Sqrt(Convert.ToDouble(context.Variables["number1"], CultureInfo.InvariantCulture)).ToString(CultureInfo.InvariantCulture);
